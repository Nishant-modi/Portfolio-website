...
export default function Starter() {
  return (
    <StandardReality playerProps= {{pos : [-45,1,65] , speed : 6}} environmentProps={{pauseMenu : null}}>
      ...
      <Video src="./Banners/Mirrors_Banner.mp4" size={12.1} position = {[-86.2, 6, 11.65]} rotation-y={(Math.PI)+0.153} framed frameWidth={1} /> {/*left first banner*/}
      ...
      <Video src="./Banners/Rockmyboat_Banner.mp4" size={12.1} position = {[-97.65, 6, 13.4]} rotation-y={(Math.PI)+0.153} framed frameWidth={1} />  {/*left middle banner*/}
